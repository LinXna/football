    ...
    if (mode !== 'parlay_check') {
      ...
      const processedMatches = allMatchesResults.map((rawMatch: any, idx: number) => {
        ...
        return {
          ...
          unified_stats: inputMatch?.unified_stats || matchResult.unified_stats || null,
          market_snapshots: inputMatch?.market_snapshots || matchResult.market_snapshots || null,
          tactical_context: inputMatch?.tactical_context || matchResult.tactical_context || null,
          timeline_events: inputMatch?.timeline_events || matchResult.timeline_events || [],
