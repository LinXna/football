    ...
    for (const item of items) {
        ...
        liveDecisions.forEach((d: any, idx: number) => {
          ...
          if (nameMatches || (homeMatches && awayMatches)) {
            ...
            liveDecisions[idx] = {
              ...
              verified_ybty_markets: item.verified_ybty_markets || d.verified_ybty_markets || [],
              ybty_raw_markets: item.ybty_raw_markets || d.ybty_raw_markets || [],
              timeline_events: item.timeline_events || d.timeline_events || [],
              attack_momentum_timeline: item.attack_momentum_timeline || d.attack_momentum_timeline || null,
      ...
      if (!matchedInLive && !matchedInPrematch) {
        ...
        const newRecord = {
          ...
          verified_ybty_markets: item.verified_ybty_markets || [],
          ybty_raw_markets: item.ybty_raw_markets || [],
          timeline_events: item.timeline_events || [],
          attack_momentum_timeline: item.attack_momentum_timeline || null,
