 ...
 */
export const NATIONAL_TEAM_TIERS: Record<string, FootballTier> = {
  // --- 欧洲 (UEFA) ---
 ...
 */
export const CLUB_TIERS: Record<string, FootballTier> = {
  // --- 欧洲 T1 超级豪门 ---
 ...
 * 显式全球联赛/杯赛层级表
 */
export const LEAGUE_TIERS: Record<string, FootballTier> = {
  // --- T1: 全球顶级联赛与欧冠 ---
